...
It **includes** the ADT Map for proposed exercises during class.
...
```bash
$> git clone https://github.com/estsetubal-atad/ADTMap_Template.git <program-dir-name>
```
...
```bash
$> git clone https://github.com/estsetubal-atad/ADTMap_Template.git MyOwnCProgram
$> code MyOwnCProgram
```
